...
![Robotron Top View](/img/robotron_top_view.jpg)
...
![Robotron Workspace](/img/robotron_workspace.jpg)
...
![Robotron Group Photo](/img/robotron_group_photo.jpg)
...
![Robotron Setup](/img/robotron_setup.jpg)
...
![Robotron Frame](/img/robotron_cordinate_frame.jpg)

    </div>

    <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '8px', width: '100%', aspectRatio: '16/9', backgroundColor: '#f0f0f0' }}>

![Robotron Broken Part](/img/robotron_broken_part.jpg)
