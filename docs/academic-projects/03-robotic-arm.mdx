---
image: /img/robotron_top_view.jpg
...
we saw it as the perfectly closed fit to provide an optimal balance between our
...
<img src={useBaseUrl('/img/robotron_top_view.jpg')} alt="Robotron Top View" style={{ width: '100%', height: 'auto', display: 'block', borderRadius: '8px' }} />

  </div>
</div>

## Objectives
1. To design and fabricate a 4-DoF robotic manipulator for pick-and-place tasks.
...
<img src={useBaseUrl('/img/robotron_workspace.jpg')} alt="Robotron Workspace" style={{ width: '100%', maxWidth: '800px', height: 'auto', display: 'block', margin: '0 auto', borderRadius: '8px' }} />
...
links resulting from haphazard motion of the manipulator
during initial tests. (My take away: Simulation first always save time and resources)
...
general and layed a grounded foundation for future works.
My Robotics course instructor, Mr. Obed Doku, second
from left in the group photo below was pleased with our performance in
...
<img src={useBaseUrl('/img/robotron_group_photo.jpg')} alt="Robotron Group Photo" style={{ width: '100%', maxWidth: '800px', height: 'auto', display: 'block', margin: '0 auto 1rem', borderRadius: '8px' }} />
Starting from left to right: Myself, Mr. Obed Doku (Robotics and control systems lecturer) and two of my group members.
...
<img src={useBaseUrl('/img/robotron_setup.jpg')} alt="Robotron Setup" style={{ width: '100%', maxWidth: '800px', height: 'auto', display: 'block', margin: '0 auto', borderRadius: '8px' }} />
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px', padding: '20px' }}>
  <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '8px', width: '100%', aspectRatio: '16/9', backgroundColor: '#f0f0f0' }}>

<img src={useBaseUrl('/img/robotron_top_view.jpg')} alt="Robotron Top View" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />

  </div>
  
  <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '8px', width: '100%', aspectRatio: '16/9', backgroundColor: '#f0f0f0' }}>

<img src={useBaseUrl('/img/robotron_workspace.jpg')} alt="Robotron Workspace" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />

  </div>
  
  <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '8px', width: '100%', aspectRatio: '16/9', backgroundColor: '#f0f0f0' }}>

<img src={useBaseUrl('/img/robotron_setup.jpg')} alt="Robotron Setup" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
...
<img src={useBaseUrl('/img/robotron_cordinate_frame.jpg')} alt="Robotron Frame" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
...
<VideoPlayer src="https://youtube.com/shorts/fPyBSoZq-HU?si=EW2l9RGXFs5p22EY"/>
